...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3611394339ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gambling4you&table=sessionids">`gambling4you`.`sessionids`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gambling4you&table=user">`gambling4you`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gambling4you&table=gamerecord">`gambling4you`.`gamerecord`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gambling4you&table=games">`gambling4you`.`games`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gambling4you&table=User">`gambling4you`.`User`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tournamentmanager&table=spieler">`tournamentmanager`.`spieler`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tournamentmanager&table=format">`tournamentmanager`.`format`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="426049293b7269294a77302e304a5c4c">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="gambling4you" targettable="user">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="gambling4you" targettable="sessionids">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `sessionids`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gambling4you" targettable="sessionids">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `sessionids` (`ID`, `User`, `SessionID`) VALUES (NULL, &#039;1&#039;, &#039;132321&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gambling4you" targettable="sessionids">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `sessionids` (`ID`, `User`, `SessionID`) VALUES (NULL, &#039;1&#039;, &#039;234664&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gambling4you" targettable="sessionids">
                            <div class="action_content">
